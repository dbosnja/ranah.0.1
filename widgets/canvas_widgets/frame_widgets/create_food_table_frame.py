...
class CreateFoodLabelFrame:
    ...
    def _create_widgets(self):
        ...
        self.topic_lbl = ttk.Label(self.frame, text=self.text_constants['topic_lbl'], anchor='center', padding=4)
        
        self.calory_lbl = ttk.Label(self.frame, text=self.text_constants['calory_lbl'],
                                    anchor='center', borderwidth=2, relief='groove', padding=4)
        ...
        self.food_name_e = ttk.Entry(self.frame, textvariable=self.food_name_var,
                                     validate='all', validatecommand=self._validate_food_name, width=50)
        
        self.create_btn = ttk.Button(self.frame, text=self.text_constants['create_btn'],
                                     command=self._create_new_record, state='disabled', padding=4)
    
    def _grid_widgets(self):
        self.topic_lbl.grid(row=0, column=0, pady=10, columnspan=2)
        self.calory_lbl.grid(row=1, column=0, sticky='e', padx=5, pady=2)
        self.calory_e.grid(row=1, column=1, pady=3, sticky='w', padx=5)
        self.fat_lbl.grid(row=2, column=0, sticky='e', padx=5, pady=2)
        self.fat_e.grid(row=2, column=1, pady=3, sticky='w', padx=5)
        self.saturated_fat_lbl.grid(row=3, column=0, sticky='e', padx=5, pady=2)
        self.sat_fat_e.grid(row=3, column=1, pady=3, sticky='w', padx=5)
        self.carbs_lbl.grid(row=4, column=0, sticky='e', padx=5, pady=2)
        self.carbs_e.grid(row=4, column=1, pady=3, sticky='w', padx=5)
        self.sugar_lbl.grid(row=5, column=0, sticky='e', padx=5, pady=2)
        self.sugar_e.grid(row=5, column=1, pady=3, sticky='w', padx=5)
        self.proteins_lbl.grid(row=6, column=0, sticky='e', padx=5, pady=2)
        self.protein_e.grid(row=6, column=1, pady=3, sticky='w', padx=5)
        self.fiber_lbl.grid(row=7, column=0, sticky='e', padx=5, pady=2)
        self.fiber_e.grid(row=7, column=1, pady=3, sticky='w', padx=5)
        self.food_name_lbl.grid(row=8, column=0, sticky='e', padx=5, pady=2)
        self.food_name_e.grid(row=8, column=1, pady=3, sticky='w', padx=5)
        self.create_btn.grid(row=9, column=0, pady=3, columnspan=2)
