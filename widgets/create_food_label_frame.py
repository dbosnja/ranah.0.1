...
class CreateFoodLabelFrame:
    ...
    def _grid_widgets(self):
        ...
        self.calory_lbl.grid(row=1, column=0, sticky='e', padx=5)
        self.calory_e.grid(row=1, column=1, pady=10, sticky='w', padx=5)
        self.fat_lbl.grid(row=2, column=0, sticky='e', padx=5)
        self.fat_e.grid(row=2, column=1, pady=10, sticky='w', padx=5)
        self.saturated_fat_lbl.grid(row=3, column=0, sticky='e', padx=5)
        self.sat_fat_e.grid(row=3, column=1, pady=10, sticky='w', padx=5)
        self.carbs_lbl.grid(row=4, column=0, sticky='e', padx=5)
        self.carbs_e.grid(row=4, column=1, pady=10, sticky='w', padx=5)
        self.sugar_lbl.grid(row=5, column=0, sticky='e', padx=5)
        self.sugar_e.grid(row=5, column=1, pady=10, sticky='w', padx=5)
        self.proteins_lbl.grid(row=6, column=0, sticky='e', padx=5)
        self.protein_e.grid(row=6, column=1, pady=10, sticky='w', padx=5)
        self.fiber_lbl.grid(row=7, column=0, sticky='e', padx=5)
        self.fiber_e.grid(row=7, column=1, pady=10, sticky='w', padx=5)
